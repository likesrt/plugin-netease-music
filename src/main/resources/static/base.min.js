...
! function(t, e) {
    ...
    t.fn.jPlayer = function(e) {
        var s = "string" == typeof e,
                i = Array.prototype.slice.call(arguments, 1),
                a = this,
                e = !s && i.length ? t.extend.apply(null, [!0, e].concat(i)) : e;
        return s && "_" === e.charAt(0) ? a : (s ? this.each(function() {
            var s = t(this).data("jPlayer"),
                    n = s && t.isFunction(s[e]) ? s[e].apply(s, i) : s;
            return n !== s && void 0 !== n ? (a = n, !1) : void 0
        }) : this.each(function() {
            var s = t(this).data("jPlayer");
            s ? s.option(e || {}) : t(this).data("jPlayer", new t.jPlayer(e, this))
        }), a)
    ...
    e.prototype = {
        ...
        time: function(t) {
            var e = new Date(1e3 * (t && "number" == typeof t ? t : 0)),
                    s = e.getUTCHours(),
                    t = this.options.timeFormat.showHour ? e.getUTCMinutes() : e.getUTCMinutes() + 60 * s,
                    e = this.options.timeFormat.showMin ? e.getUTCSeconds() : e.getUTCSeconds() + 60 * t,
                    s = this.options.timeFormat.padHour && 10 > s ? "0" + s : s,
                    t = this.options.timeFormat.padMin && 10 > t ? "0" + t : t,
                    e = this.options.timeFormat.padSec && 10 > e ? "0" + e : e,
                    s = "" + (this.options.timeFormat.showHour ? s + this.options.timeFormat.sepHour : ""),
                    s = s + (this.options.timeFormat.showMin ? t + this.options.timeFormat.sepMin : "");
            return s += this.options.timeFormat.showSec ? e + this.options.timeFormat.sepSec : ""
        }
    };
    var s = new e;
    t.jPlayer.convertTime = function(t) {
        ...
        var t = t.toLowerCase(),
                ...
                s = /(msie) ([\w.]+)/,
                i = /(mozilla)(?:.*? rv:([\w.]+))?/,
                t = /(webkit)[ \/]([\w.]+)/.exec(t) || e.exec(t) || s.exec(t) || t.indexOf("compatible") < 0 && i.exec(t) || [];
        return {
            browser: t[1] || "",
            version: t[2] || "0"
        }
        ...
        var e = t.toLowerCase(),
                s = /(android)/,
                i = /(mobile)/,
                t = /(ipad|iphone|ipod|android|blackberry|playbook|windows ce|webos)/.exec(e) || [],
                e = /(ipad|playbook)/.exec(e) || !i.exec(e) && s.exec(e) || [];
        return t[1] && (t[1] = t[1].replace(/\s/g, "_")), {
            platform: t[1] || "",
            tablet: e[1] || ""
        }
    }, t.jPlayer.browser = {}, t.jPlayer.platform = {};
    var i = t.jPlayer.uaBrowser(navigator.userAgent);
    i.browser && (t.jPlayer.browser[i.browser] = !0, t.jPlayer.browser.version = i.version), i = t.jPlayer.uaPlatform(navigator.userAgent), i.platform && (t.jPlayer.platform[i.platform] = !0, t.jPlayer.platform.mobile = !i.tablet, t.jPlayer.platform.tablet = !!i.tablet), t.jPlayer.getDocMode = function() {
        var e;
        ...
        init: function() {
            ...
            for (this.fullscreen = i = {
                support: {
                    ...
                    webkitVideo: "function" == typeof i[a.webkitVideo[2]]
                },
                used: {}
            }, t = 0, e = n.length; e > t; t++) {
                var o = n[t];
                if (i.support[o]) {
                    i.spec = o, i.used[o] = !0;
                    break
            ...
            if (i.spec) {
                ...
                i.api = {
                    ...
                    fullscreenElement: function(t) {
                        return t = t ? t : s, t[r[1]]
                    },
                    requestFullscreen: function(t) {
                        return t[r[2]]()
                    },
                    exitFullscreen: function(t) {
                        return t = t ? t : s, t[r[3]]()
                    }
                }, i.event = {
    ...
    t.jPlayer.keys = function(e) {
        t(document.documentElement).unbind("keydown.jPlayer"), e && t(document.documentElement).bind("keydown.jPlayer", a)
        ...
        _init: function() {
            ...
            if (this.element.empty(), this.status = t.extend({}, this.status), this.internal = t.extend({}, this.internal), this.options.timeFormat = t.extend({}, t.jPlayer.timeFormat, this.options.timeFormat), this.internal.cmdsIgnored = t.jPlayer.platform.ipad || t.jPlayer.platform.iphone || t.jPlayer.platform.ipod, this.internal.domNode = this.element.get(0), this.options.keyEnabled && !t.jPlayer.focus && (t.jPlayer.focus = this), this.formats = [], this.solutions = [], this.require = {}, this.htmlElement = {}, this.html = {}, this.html.audio = {}, this.html.video = {}, this.flash = {}, this.css = {}, this.css.cs = {}, this.css.jq = {}, this.ancestorJq = [], this.options.volume = this._limitValue(this.options.volume, 0, 1), t.each(this.options.supplied.toLowerCase().split(","), function(s, i) {
                ...
                if (e.format[a]) {
                    var n = !1;
                    t.each(e.formats, function(t, e) {
                        return a === e ? (n = !0, !1) : void 0
                    }), n || e.formats.push(a)
                }
            }), t.each(this.options.solution.toLowerCase().split(","), function(s, i) {
                var a = i.replace(/^\s+|\s+$/g, "");
                if (e.solution[a]) {
                    var n = !1;
                    t.each(e.solutions, function(t, e) {
                        return a === e ? (n = !0, !1) : void 0
                    }), n || e.solutions.push(a)
                }
                ...
                void 0 !== e.options[t] && (e.element.bind(s + ".jPlayer", e.options[t]), e.options[t] = void 0)
            }), this.require.audio = !1, this.require.video = !1, t.each(this.formats, function(t, s) {
                ...
                e._trigger(t.jPlayer.event.click)
            }), this.html.audio.available = !1, this.require.audio && (this.htmlElement.audio = document.createElement("audio"), this.htmlElement.audio.id = this.internal.audio.id, this.html.audio.available = !!this.htmlElement.audio.canPlayType && this._testCanPlayType(this.htmlElement.audio)), this.html.video.available = !1, this.require.video && (this.htmlElement.video = document.createElement("video"), this.htmlElement.video.id = this.internal.video.id, this.html.video.available = !!this.htmlElement.video.canPlayType && this._testCanPlayType(this.htmlElement.video)), this.flash.available = this._checkForFlash(10.1), this.html.canPlay = {}, this.flash.canPlay = {}, t.each(this.formats, function(t, s) {
                e.html.canPlay[s] = e.html[e.format[s].media].available && "" !== e.htmlElement[e.format[s].media].canPlayType(e.format[s].codec), e.flash.canPlay[s] = e.format[s].flashCanPlay && e.flash.available
            }), this.html.desired = !1, this.flash.desired = !1, t.each(this.solutions, function(s, i) {
                if (0 === s) e[i].desired = !0;
                else {
                    var a = !1,
                            n = !1;
                    t.each(e.formats, function(t, s) {
                        e[e.solutions[0]].canPlay[s] && ("video" === e.format[s].media ? n = !0 : a = !0)
                    }), e[i].desired = e.require.audio && !a || e.require.video && !n
                }
            }), this.html.support = {}, this.flash.support = {}, t.each(this.formats, function(t, s) {
                e.html.support[s] = e.html.canPlay[s] && e.html.desired, e.flash.support[s] = e.flash.canPlay[s] && e.flash.desired
            }), this.html.used = !1, this.flash.used = !1, t.each(this.solutions, function(s, i) {
                t.each(e.formats, function(t, s) {
                    return e[i].support[s] ? (e[i].used = !0, !1) : void 0
                })
                ...
                if (t.jPlayer.browser.msie && (Number(t.jPlayer.browser.version) < 9 || t.jPlayer.browser.documentMode < 9)) {
                    ...
                    for (var a = 0; a < i.length; a++) s.appendChild(document.createElement(i[a]))
                } else a = function(t, e, s) {
                    var i = document.createElement("param");
                    i.setAttribute("name", e), i.setAttribute("value", s), t.appendChild(i)
                }, s = document.createElement("object"), s.setAttribute("id", this.internal.flash.id), s.setAttribute("name", this.internal.flash.id), s.setAttribute("data", this.internal.flash.swf), s.setAttribute("type", "application/x-shockwave-flash"), s.setAttribute("width", "1"), s.setAttribute("height", "1"), s.setAttribute("tabindex", "-1"), a(s, "flashvars", i), a(s, "allowscriptaccess", "always"), a(s, "bgcolor", this.options.backgroundColor), a(s, "wmode", this.options.wmode);
            ...
            this.status.playbackRateEnabled = this.html.used && !this.flash.used ? this._testPlaybackRate("audio") : !1, this._updatePlaybackRate(), this.html.used && (this.html.audio.available && (this._addHtmlEventListeners(this.htmlElement.audio, this.html.audio), this.element.append(this.htmlElement.audio), this.internal.audio.jq = t("#" + this.internal.audio.id)), this.html.video.available && (this._addHtmlEventListeners(this.htmlElement.video, this.html.video), this.element.append(this.htmlElement.video), this.internal.video.jq = t("#" + this.internal.video.id), this.status.nativeVideoControls ? this.internal.video.jq.css({
                ...
                e.internal.ready = !0, e.version.flash = "n/a", e._trigger(t.jPlayer.event.repeat), e._trigger(t.jPlayer.event.ready)
        ...
        _getHtmlStatus: function(t, e) {
            var s = 0,
                    ...
                    a = 0,
                    n = 0;
            isFinite(t.duration) && (this.status.duration = t.duration), s = t.currentTime, i = this.status.duration > 0 ? 100 * s / this.status.duration : 0, "object" == typeof t.seekable && t.seekable.length > 0 ? (a = this.status.duration > 0 ? 100 * t.seekable.end(t.seekable.length - 1) / this.status.duration : 100, n = this.status.duration > 0 ? 100 * t.currentTime / t.seekable.end(t.seekable.length - 1) : 0) : (a = 100, n = i), e && (i = n = s = 0), this.status.seekPercent = a, this.status.currentPercentRelative = n, this.status.currentPercentAbsolute = i, this.status.currentTime = s, this.status.videoWidth = t.videoWidth, this.status.videoHeight = t.videoHeight, this.status.readyState = t.readyState, this.status.networkState = t.networkState, this.status.playbackRate = t.playbackRate, this.status.ended = t.ended
        },
        _resetStatus: function() {
            this.status = t.extend({}, this.status, t.jPlayer.prototype.status)
        },
        _trigger: function(e, s, i) {
            e = t.Event(e), e.jPlayer = {}, e.jPlayer.version = t.extend({}, this.version), e.jPlayer.options = t.extend(!0, {}, this.options), e.jPlayer.status = t.extend(!0, {}, this.status), e.jPlayer.html = t.extend(!0, {}, this.html), e.jPlayer.flash = t.extend(!0, {}, this.flash), s && (e.jPlayer.error = t.extend({}, s)), i && (e.jPlayer.warning = t.extend({}, i)), this.element.trigger(e)
        },
        ...
        _updateButtons: function(t) {
            void 0 === t ? t = !this.status.paused : this.status.paused = !t, this.css.jq.play.length && this.css.jq.pause.length && (t ? (this.css.jq.play.hide(), this.css.jq.pause.show()) : (this.css.jq.play.show(), this.css.jq.pause.hide())), this.css.jq.restoreScreen.length && this.css.jq.fullScreen.length && (this.status.noFullWindow ? (this.css.jq.fullScreen.hide(), this.css.jq.restoreScreen.hide()) : this.options.fullWindow ? (this.css.jq.fullScreen.hide(), this.css.jq.restoreScreen.show()) : (this.css.jq.fullScreen.show(), this.css.jq.restoreScreen.hide())), this.css.jq.repeat.length && this.css.jq.repeatOff.length && (this.options.loop ? (this.css.jq.repeat.hide(), this.css.jq.repeatOff.show()) : (this.css.jq.repeat.show(), this.css.jq.repeatOff.hide()))
        },
        ...
        _absoluteMediaUrls: function(e) {
            ...
            return t.each(e, function(t, i) {
                s.format[t] && (e[t] = s._qualifyURL(i))
            }), e
        },
        setMedia: function(e) {
            var s = this,
        ...
        play: function(t) {
            t = "number" == typeof t ? t : NaN, this.status.srcSet ? (this.focus(), this.html.active ? this._html_play(t) : this.flash.active && this._flash_play(t)) : this._urlNotSetError("play")
        },
        videoPlay: function() {
            this.play()
        },
        pause: function(t) {
            t = "number" == typeof t ? t : NaN, this.status.srcSet ? this.html.active ? this._html_pause(t) : this.flash.active && this._flash_pause(t) : this._urlNotSetError("pause")
        },
        ...
        mute: function(t) {
            this._muted(void 0 === t ? !0 : !!t)
        },
        unmute: function(t) {
            this._muted(!(void 0 === t || t))
        },
        _updateMute: function(t) {
            void 0 === t && (t = this.options.muted), this.css.jq.mute.length && this.css.jq.unmute.length && (this.status.noVolume ? (this.css.jq.mute.hide(), this.css.jq.unmute.hide()) : t ? (this.css.jq.mute.hide(), this.css.jq.unmute.show()) : (this.css.jq.mute.show(), this.css.jq.unmute.hide()))
        },
        volume: function(t) {
        ...
        volumeBar: function(e) {
            if (this.css.jq.volumeBar.length) {
                var s = t(e.currentTarget),
                        ...
                        a = e.pageX - i.left,
                        n = s.width(),
                        e = s.height() - e.pageY + i.top,
                        s = s.height();
                this.options.verticalVolume ? this.volume(e / s) : this.volume(a / n)
            }
            this.options.muted && this._muted(!1);
        },
        _updateVolume: function(t) {
            void 0 === t && (t = this.options.volume), t = this.options.muted ? 0 : t, this.status.noVolume ? (this.css.jq.volumeBar.length && this.css.jq.volumeBar.hide(), this.css.jq.volumeBarValue.length && this.css.jq.volumeBarValue.hide(), this.css.jq.volumeMax.length && this.css.jq.volumeMax.hide()) : (this.css.jq.volumeBar.length && this.css.jq.volumeBar.show(), this.css.jq.volumeBarValue.length && (this.css.jq.volumeBarValue.show(), this.css.jq.volumeBarValue[this.options.verticalVolume ? "height" : "width"](100 * t + "%")), this.css.jq.volumeMax.length && this.css.jq.volumeMax.show())
        },
        volumeMax: function() {
        ...
        _cssSelector: function(e, s) {
            var i = this;
            "string" == typeof s ? t.jPlayer.prototype.options.cssSelector[e] ? (this.css.jq[e] && this.css.jq[e].length && this.css.jq[e].unbind(".jPlayer"), this.options.cssSelector[e] = s, this.css.cs[e] = this.options.cssSelectorAncestor + " " + s, this.css.jq[e] = s ? t(this.css.cs[e]) : [], this.css.jq[e].length && this[e] && this.css.jq[e].bind("click.jPlayer", function(s) {
        ...
        playbackRateBar: function(e) {
            if (this.css.jq.playbackRateBar.length) {
                var s = t(e.currentTarget),
                        ...
                        e = s.height() - e.pageY + i.top,
                        s = s.height();
                this.playbackRate((this.options.verticalPlaybackRate ? e / s : a / n) * (this.options.maxPlaybackRate - this.options.minPlaybackRate) + this.options.minPlaybackRate)
            }
        },
        ...
        option: function(e, s) {
            ...
            if ("string" == typeof e) {
                var a = e.split(".");
                if (void 0 === s) {
                    for (var i = t.extend(!0, {}, this.options), n = 0; n < a.length; n++) {
                        if (void 0 === i[a[n]]) return void this._warning({
                ...
                for (var n = i = {}, o = 0; o < a.length; o++) o < a.length - 1 ? (n[a[o]] = {}, n = n[a[o]]) : n[a[o]] = s
            }
        ...
        _setOption: function(e, s) {
            ...
            switch (e) {
                ...
                case "noVolume":
                    ...
                    break;
                case "emulateHtml":
                    this.options[e] !== s && ((this.options[e] = s) ? this._emulateHtmlBridge() : this._destroyHtmlBridge());
                    break;
                case "timeFormat":
        ...
        _getFlashPluginVersion: function() {
            ...
            } catch (i) {} else navigator.plugins && navigator.mimeTypes.length > 0 && (t = navigator.plugins["Shockwave Flash"]) && (e = navigator.plugins["Shockwave Flash"].description.replace(/.*\s(\d+\.\d+).*/, "$1"));
            return 1 * e
        },
        ...
        _warning: function(e) {
            this._trigger(t.jPlayer.event.warning, void 0, e), this.options.warningAlerts && this._alert("Warning!" + (e.message ? "\n" + e.message : "") + (e.hint ? "\n" + e.hint : "") + "\nContext: " + e.context)
        },
        _alert: function(t) {
            t = "jPlayer " + this.version.script + " : id='" + this.internal.self.id + "' : " + t, this.options.consoleAlerts ? console && console.log && console.log(t) : alert(t)
        },
        ...
        _destroyHtmlBridge: function() {
            var e = this;
            this.element.unbind(".jPlayerHtml"), t.each((t.jPlayer.emulateMethods + " " + t.jPlayer.emulateStatus + " " + t.jPlayer.emulateOptions).split(/\s+/g), function(t, s) {
